...
const ORGANS: Organ[] = [
  ...
  },
  {
    ...
    role: '대외적 의사표시',
    icon: PenLine,
    note: '회사를 대표해 바깥과 거래한다. 법인격은 스스로 의사를 표시할 수 없으므로 계약서에는 대표이사가 개인이 아니라 회사의 기관 자격으로 서명한다.',
  },
  {
    id: 'counterparty',
    name: '거래 상대방',
    ...
    : needsMeeting
      ...
      : counterpartyKnew
        ...
        : {
            ...
            text: `${procedure}를 빠뜨렸더라도 상대방이 그 사실을 몰랐고 모른 데 중대한 과실만 없었다면 계약은 유효하고, 효과는 회사에 귀속된다. 회사는 절차를 건너뛴 대표에게 손해배상을 물을 수 있을 뿐이다.`,
          };
