...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    legal: true,
    detail:
      '자연인은 소득세, 법인은 법인세를 낸다. 회사가 번 돈에 법인세를 물고, 남은 돈을 배당하면 받는 주주가 다시 소득세를 낸다. 인격이 둘이라 과세도 두 번이고, 겹치는 몫은 배당세액공제로 일부 덜어 준다.',
  },
  {
    id: 'own',
    label: '다른 회사의 주주가 된다',
  ...
  },
  {
    ...
    legal: false,
    detail:
      '자유형은 자연인에게만 집행할 수 있어 법인에 과할 수 있는 형벌은 벌금·과료·몰수뿐이다. 위법행위를 실제로 저지른 임직원을 처벌하는 데 더해 법인에도 벌금을 물리는 것이 양벌규정이다.',
  },
  {
    id: 'die',
    label: '수명이 있다',
    ...
    legal: false,
    detail:
      '자연인의 인격은 사망으로 끝나지만 법인격은 설립등기로 생겨 청산종결로 소멸한다. 창업자가 사망해도 회사는 그대로 남고 그가 가졌던 주식만 상속인에게 넘어간다. 정관에 존립기간을 적지 않는 한 수명의 제한이 없다.',
  },
];
