...
export function SoftwarVsHardwar() {
  ...
  const r = useMemo(() => deterrence({ projectedPower, adversaryBenefit }), [projectedPower, adversaryBenefit]);
    ...
    <div className='flex flex-col gap-4'>
      ...
      <Card
        className={cn(
          ...
          r.deterred ? 'border-emerald-500/40 bg-emerald-500/5' : 'border-rose-500/40 bg-rose-500/5',
        )}
      >
      ...
      <ExplainCard
        ...
        preview='핵 억지가 도시를 태운다면, 작업증명은 전기만 태워 같은 억지를 만든다.'
