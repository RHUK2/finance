    ...
    <ExplainerPage
      ...
      intro={
        <>
          ...
          있어서 금리가 움직이면 전세와 월세의 유불리가 뒤바뀌고, 보증금은 집을 사는 지렛대가 되며, 집값이 빠지면 손실이
          임차인에게로 흘러간다. 네 갈래로 나눠 직접 만져 보자.
        </>
      }
    >
      <IllustrativeDisclaimer>
        등장하는 보증금·매매가·낙찰가와 하락률은 구조를 보여주기 위한 예시다. 경매 배당은 순위가 어떻게 작동하는지
        드러내려고 근저당과 임차인 둘만 남겨 단순화했고, 소액임차인 최우선변제나 당해세처럼 실제 배당에서 앞서는 항목은
        넣지 않았다. 실제 사안의 판단 기준과는 다르다.
      </IllustrativeDisclaimer>
