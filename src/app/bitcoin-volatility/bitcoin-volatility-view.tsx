    ...
    <>
      ...
      <PageMain>
        <div className='mx-auto flex max-w-5xl flex-col gap-4'>
          <div>
            <h1 className='text-xl font-semibold'>변동성 = 체제 전환 확률의 가격</h1>
            <p className='text-muted-foreground mt-1 text-sm/relaxed'>
              비트코인은 왜 이렇게 심하게 출렁일까? 시장은 매일 &#39;비트코인이 결국 진짜 화폐로 자리 잡을까&#39;를 두고
              성공 확률을 새로 매긴다. 그 확률이 조금만 바뀌어도 가격은 크게 움직인다. 즉 변동성은 결함이 아니라, 이
              질문에 대한 시장의 답이 실시간으로 흔들리는 모습이다. 앞의 두 탭은 이 발상을 시뮬레이션으로 돌려 보고,
              마지막 탭은 실제 데이터로 확인한다. 여기서 쓰는 가격 모델은 &#39;왜 출렁이는가&#39;에 답하는 것이지 적정
              가격을 계산하는 모델이 아니다.
            </p>
          </div>
