...
export const DEMAND_STAGES: DemandStage[] = [
  ...
  },
  {
    ...
    narration:
      '1971년 닉슨이 금 태환을 중단하면서 담보가 없어졌다. 1973~74년 미국은 사우디에 군사 보호를 주고 석유 결제를 달러로만 하기로 합의했고 OPEC이 뒤따랐다. 석유는 담보가 아니라 결제통화를 고정해 달러를 사야만 하게 만든 강제된 수요다. 담보가 없어져도 수요원이 남아 있으면 체제는 버틴다.',
    broke:
