...
export function EcdsaView() {
  // 개인키·메시지 해시·일회용 비밀값은 네 탭이 함께 쓴다. 탭마다 따로 두면 ③탭에서
  // 만든 서명과 ④탭이 검증하는 서명이 달라져 설명이 끊긴다.
  ...
  return (
    ...
    >
      <IllustrativeDisclaimer>
        ...
        맞는다. 다만 곡선이 작아서 안전하지 않다. 개인키 후보가 {N - 1}개뿐이라 ⑤탭에서 보듯 즉시 뚫린다. 실제
        secp256k1은 같은 알고리즘을 2²⁵⁶ 규모에서 돌린다. 여기서 만든 어떤 값도 실제 지갑이나 자금에 쓰지 말 것.
      </IllustrativeDisclaimer>
