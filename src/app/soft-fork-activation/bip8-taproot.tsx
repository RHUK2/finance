    ...
    <div className='flex flex-col gap-4'>
      ...
      <Card className='flex flex-col gap-3 p-4'>
        ...
        <p className='text-muted-foreground text-sm/relaxed'>
          ...
          다수의 동의로 정상 활성화됐다. ②에서 본 95%와 다른 이유는 임계값이 프로토콜에 박힌 상수가 아니라 배포마다
          정하는 파라미터이기 때문이다. Speedy Trial은 짧은 기간에 결론을 내려고 문턱을 90%(2016블록 중 1815개)로 낮춰
          잡았다. UASF의 &#39;강제 켜기&#39;가 실제로 발동되진 않았지만, 그 가능성 자체가 채굴자들이 굳이 반대할 이유를
          없앴다는 평가를 받는다.
        </p>
      </Card>
