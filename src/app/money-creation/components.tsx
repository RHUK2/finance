    ...
    <ExplainCard
      ...
      body={
        <div className='space-y-2'>
          ...
          <p>
            오늘날 달러를 떠받치는 것은 담보가 아니라 <b>수요원</b>이다. 세계 최강의 군사력, 원유를 달러로 결제하는
            페트로달러 체제, 미국채에 대한 전 세계의 수요가 달러를 벌어 두게 만든다. 1971년 금태환이 중단되며
            &#39;금으로 바꿔준다&#39;는 담보는 사라졌지만, 수요원은 남아 달러를 지탱한다.
          </p>
          <p>
