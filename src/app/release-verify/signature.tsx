        ...
        body={
          <>
            ...
            <p className='mt-2'>
              ...
              ECDSA P-256으로 내려오는데, 그래도 위 네 경우의 결론은 한 글자도 달라지지 않는다. 실제 릴리스 서명도
              마찬가지다. 여기서 다루는 넷 중 셋은 GPG를 쓰고 하나는 GPG가 아니라 비트코인과 같은 secp256k1로
              서명하는데, 어느 쪽이든 결론은 같다. 곡선과 도구는 갈려도 &#39;누구 키냐&#39;는 질문은 갈리지 않는다.
              곡선이 같다고 해서 릴리스 서명 키가 지갑 키와 무슨 관계가 있는 것도 아니다. 서명 자체의 수학은{' '}
