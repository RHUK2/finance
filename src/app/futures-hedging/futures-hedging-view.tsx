...
export function FuturesHedgingView() {
  return (
    <>
      <AppHeader breadcrumbs={[{ label: '선물·헤징' }]} />
      <PageMain>
        <div className='mx-auto flex max-w-5xl flex-col gap-4'>
          <div>
            <h1 className='text-xl font-semibold'>위험은 사라지지 않고 이전된다</h1>
            <p className='text-muted-foreground mt-1 text-sm/relaxed'>
              ...
              장부로 건너간다. 받은 쪽이 감당하지 못하면 위험은 다시 시장 전체로 돌아온다. 네 갈래로 나눠 직접 만져
              보자.
            </p>
          </div>
          ...
          <IllustrativeDisclaimer>
            ...
            수율과 증거금 규정도 요점이 묻히지 않게 단순화했다. 이 페이지는 어떤 포지션도 권하지 않고, 실제 거래의
            손익이나 청산 조건을 계산하는 데 쓸 수 없다.
          </IllustrativeDisclaimer>
