...
export function FuturesHedgingView() {
  return (
    <ExplainerPage
      ...
      intro={
        <>
          선물은 미래의 가격을 맞히는 도박처럼 보이지만, 그 시장을 만든 쪽은 가격을 맞히려는 사람이 아니라 맞히지 않아도
          되게 만들려는 사람이었다. 헤저가 가격 위험을 벗는 순간 그 위험은 증발하지 않고 반대편 장부로 건너간다. 받은
          쪽이 감당하지 못하면 위험은 다시 시장 전체로 돌아온다. 네 갈래로 나눠 직접 만져 보자.
        </>
      }
    >
