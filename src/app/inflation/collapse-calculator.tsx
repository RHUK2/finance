...
export function CollapseCalculator({ data, btc, currency, minYear, maxYear, amount, stockLabel }: Props) {
  ...
  const r = useMemo(() => {
    ...
    const depositNominal = compoundDeposit(amount, data.deposit?.history, startYear);
  ...
  const ready = r.depositNominal != null && r.holdLine != null && r.ratio != null && r.lossPct != null;
