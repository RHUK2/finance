      ...
      <ExplainCard
        ...
        body={
          <div className='flex flex-col gap-3'>
            ...
            <p>
              포함 관계가 있어도 리플레이는 양방향으로 일어난다. 평범한 송금 트랜잭션은 좁은 규칙도 넓은 규칙도
              만족하므로 어느 쪽에서 서명하든 반대편에서 유효하다. 포함 관계가 정하는 것은 리플레이 방향이 아니라{' '}
              <b>분리 방향</b>이다. 좁은 쪽이 거부할 요소를 일부러 넣어야만 한쪽에서만 유효한 트랜잭션이 되고, 그건 넓은
              쪽에서만 가능하다.
            </p>
          </div>
        }
