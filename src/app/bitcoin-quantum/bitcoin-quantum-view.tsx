      ...
      <PageMain>
        <div className='mx-auto flex max-w-5xl flex-col gap-4'>
          ...
          <ExplainCard
            ...
            preview='NIST 표준화가 진행 중인 양자 내성 서명으로 갈아타는 소프트포크가 논의되고 있다.'
            body='근본적 대응은 ECDSA를 양자 내성(post-quantum) 서명 알고리즘으로 교체하는 것이다. Lamport 서명, 해시 기반 서명(SPHINCS+ 등), 격자 기반 서명(NIST 표준화 대상) 등이 후보로 거론된다. 비트코인은 소프트포크로 새 서명 방식을 위한 출력 유형을 도입하고, 사용자들이 자산을 새 주소로 옮기며 자연스럽게 이행하는 시나리오가 유력하다. 실제 위협이 임박하기 훨씬 전에 표준을 확정하고 이행 창구를 열어야 한다는 게 대체적인 견해다.'
          />
        </div>
      </PageMain>
    </>
