    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-muted-foreground text-sm font-medium">Power Law 모델</CardTitle>
        ...
        {!data ? (
          ...
          ratio != null && (
            <span className="text-sm font-semibold" style={{ color: ratio > 1 ? "#f97316" : "#22c55e" }}>
              모델 대비 {ratio > 1 ? "+" : ""}{((ratio - 1) * 100).toFixed(0)}%
            </span>
          )
        )}
      </CardHeader>
